...
+ My typicall workflow: 
  ...
  - Open up a new Shiny app in RStudio (File -> New File -> Shiny Web App)
...
+ Another way to make a Shiny app is to copy the entire `ui.R` and `server.R` into one `app.R`. But I am an old man with a preference for modularisation.
